...
# Data ingestion.
from src.components_abstencao.data_ingestion import DataIngestionConfig
from src.components_abstencao.data_ingestion import DataIngestion

# Data transformation.
from src.components_abstencao.data_transformation import DataTransformationConfig
from src.components_abstencao.data_transformation import DataTransformation

# Model trainer.
from src.components_abstencao.model_trainer import ModelTrainerConfig
...
class TrainPipeline:
    ...
    def train(self):
        ...
        try:
            logging.info('Train full pipeline started - Absence Model.')
